...
public class IGServerRest {
    ...
    public String queryByID(int missingID) {
        String queryUrl = baseUrl + "query?f=json&gdbp=gdbp://MapGisLocal/GoHome/sfcls/missing_people_data_with_photo" +
    ...
    public String add() {
        ...
        String addUrl = baseUrl + "addFeatures?f=json&gdbp=gdbp://MapGisLocal/GoHome/sfcls/missing_people_data_with_photo&guid=null&s={\"AttStruct\":{\"FldNumber\":15,\"FldName\":[\"经度\",\"纬度\",\"寻亲编号\",\"寻亲类别\",\"姓名\",\"性别\",\"出生日期\",\"失踪时身高\",\"失踪时间\",\"失踪地点\",\"寻亲者特征描述\",\"其他资料\",\"注册时间\",\"经度1\",\"纬度1\"],\"FldType\":[\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\",\"string\"]},\"SFEleArray\":null,\"TotalCount\":0}";
        String result = "";
        try {
