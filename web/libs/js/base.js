...
var geoCoordMap = {
    ...
    '台湾省': [121.21, 23.53],
    '香港特别行政区': [114.1, 22.2],
    '马来西亚':[116.47713401374135,20.95929509805618],
    '菲律宾':[40.26815432596044,13.12409329121517],
    '越南':[90.9629010224008,22.547402964471306],
    '老挝':[30.73016419190513,24.992768014668894],
    '美国':[56.6529240478028,40.1212659578434],
    '乌克兰':[117.85731241207519,50.695838125962148],
    '尼泊尔':[55.68863994837386,10.437310152596858],
    '柬埔寨':[101.30994651162635,31.461536393005293],
    '缅甸':[20.4111470487352,-10.815743061502747],
    '老挝':[102.73016419190513,24.992768014668894]
};
...
function chart3(type, chartType) {
    ...
    if (type == 1) {
        data = ['1965-1975', '1965-1975', '1985-1995', '1965-1975', '2005-2015'];
...
function chart4(data, type, chartType) {
    var str = '<li><span></span><p>国家</p><p>人数</p></li>';
    for (var i = 0; i < 10; i++) {
    ...
    // let globel = echarts.init(document.getElementById('chart4s'));
    // globel.setOption(options);
