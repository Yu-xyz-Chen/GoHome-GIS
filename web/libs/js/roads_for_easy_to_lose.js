...
window.onload= function () {
    ...
    var SvrCfg = {
        vectUrl: "gdbp://MapGisLocal/GoHome/sfcls/roads_for_easy_to_lose",
        ip: "localhost",
        port: "6163"
    };
...
function drawControlback(feature) {
    ...
    //实例化查询参数对象
    var queryParam = new Zondy.Service.QueryByLayerParameter("gdbp://MapGisLocal/GoHome/sfcls/roads_for_easy_to_lose", {
        geometry: geomObj,
        resultFormat: "json",
        rule: rule,
        struct: queryStruct
...
function transFormClass(KWeight) {
    ...
    if (KWeight>0.8&&KWeight<2.2){
        return "较易失踪";
    }
    if (KWeight>2.2&&KWeight<4.3){
        return "易失踪";
    }
    if (KWeight>4.3&&KWeight<6.6){
        return "非常易失踪";
    }
    if (KWeight>6.6&&KWeight<10.0){
        return "极易失踪";
    }
}
...
function querySuccess(result) {
    ...
    var RoadType = result.SFEleArray["0"].AttValue[1];
    var KWeight = result.SFEleArray["0"].AttValue[5];
...
function queryByLine() {
    ...
    ///实例化查询参数对象
    var queryParam = new Zondy.Service.QueryByLayerParameter("gdbp://MapGisLocal/GoHome/sfcls/missing_people_data_with_photo", {
        geometry: polyLine,
        geometryType: "line",
        resultFormat: "json",
        rule: rule,
