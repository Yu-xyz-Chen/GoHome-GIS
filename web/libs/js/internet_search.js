...
function SearchBing() {
    ...
    //         // Request headers
    //         xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key","a64ad58149824b3abacf23e48034627f");
    //     },
    //     type: "GET",
    //     // Request body
    //     data: "{body}"
    ...
    var params = {
        ...
        "q": query,
        // "offset": "0",
        "customconfig":"e9886a4a-e0f3-40cb-9085-76504378641f",
        "mkt": "en-US",
        "safesearch": "Moderate",
        "count": "5",
    };
    // var url = "https://api.cognitive.microsoft.com/bing/v7.0/search?" + $.param(params);
    var url = "https://api.bing.microsoft.com/v7.0/custom/search?" + $.param(params);
    console.log(url);
    $.ajax({
        url: url,
        beforeSend: function(xhrObj){
